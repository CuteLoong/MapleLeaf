...
namespace MapleLeaf {
Framebuffers::Framebuffers(const LogicalDevice& logicalDevice, const Swapchain& swapchain, const RenderStage& renderStage,
                           const Renderpass& renderPass, const ImageDepth& depthStencil, const glm::uvec2& extent, VkSampleCountFlagBits samples)
...
{
    for (const auto& framebuffer : framebuffers) vkDestroyFramebuffer(logicalDevice, framebuffer, nullptr);
}
}   // namespace MapleLeaf