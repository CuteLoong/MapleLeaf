...
public:
    ...
    /*
     * Creates a new time. This function is internal. To construct time values, use {@link Time::Seconds}, {@link Time::Milliseconds} or {@link
    ...
    static Time Now()
    {
        static const auto LocalEpoch = std::chrono::high_resolution_clock::now();   // only first run
