...
namespace MapleLeaf {
HBAOStereoSubrender::HBAOStereoSubrender(const Pipeline::Stage& pipelineStage, HBAOData hbaoData)
    : Subrender(pipelineStage)
    , hbaoData(hbaoData)
    , pipeline(PipelineGraphics(pipelineStage, {"Shader/AO/HBAOStereo.vert", "Shader/AO/HBAOStereo.frag"}, {}, {}, PipelineGraphics::Mode::Polygon,
...
void HBAOStereoSubrender::PreRender(const CommandBuffer& commandBuffer) {}

void HBAOStereoSubrender::Render(const CommandBuffer& commandBuffer)
{
...
void HBAOStereoSubrender::PostRender(const CommandBuffer& commandBuffer) {}

std::shared_ptr<Image2d> HBAOStereoSubrender::ComputeNoise(uint32_t width, uint32_t height, uint32_t numRays)
{
