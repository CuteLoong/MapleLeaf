...
namespace MapleLeaf {
HBAOStereoWithThickSubrender::HBAOStereoWithThickSubrender(const Pipeline::Stage& pipelineStage, HBAOData hbaoData)
    : Subrender(pipelineStage)
    , hbaoData(hbaoData)
    , pipeline(PipelineGraphics(pipelineStage, {"Shader/AO/HBAOStereoWithThickness.vert", "Shader/AO/HBAOStereoWithThickness.frag"}, {}, {},
...
void HBAOStereoWithThickSubrender::PreRender(const CommandBuffer& commandBuffer) {}

void HBAOStereoWithThickSubrender::Render(const CommandBuffer& commandBuffer)
{
...
void HBAOStereoWithThickSubrender::PostRender(const CommandBuffer& commandBuffer) {}

std::shared_ptr<Image2d> HBAOStereoWithThickSubrender::ComputeNoise(uint32_t width, uint32_t height, uint32_t numRays)
{
