...
namespace MapleLeaf {
class HBAOStereoWithOcclusionInfoSubrender : public Subrender
{
public:
    struct HBAOData
    {
    ...
    explicit HBAOStereoWithOcclusionInfoSubrender(const Pipeline::Stage& pipelineStage, HBAOData hbaoData = HBAOData());
